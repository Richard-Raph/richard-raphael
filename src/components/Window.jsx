...
// import { TbTableFilled } from 'react-icons/tb';
// import { useState, useRef, useEffect, useCallback } from 'react';
// import { motion, useDrag } from 'framer-motion'; // Import useDrag
...
//   // Drag gesture handling for swipes
//   const { drag, isDragging } = useDrag({
//     onDrag: (event, info) => {
//       if (info.offset.x < -100) {
//         setIsSwiped(true);
//         closeWindow(id); // Close the window if swiped left
//       }
//     }
//   });
...
//   // Prevent dragging when maximized or on mobile
//   const handleDragStart = (e) => {
//     if (!deviceState.isLaptopAndAbove || isMaximized || deviceState.isTouchDevice) return;
...
//       style={{
//         zIndex: isActive ? 10 : 1,
//         top: isMaximized ? '0px' : `${pos.top}px`,
...
//       {...drag} // Attach drag functionality
//     >
//       <span className="glare outer" />
//       <div className="window-outline">
//         <span className="glare inner" />
...
//               <div className="window-dots">
//                 <button className="yellow" />
//                 <button className="red" onClick={() => closeWindow(id)} />
//                 <button className="green" onClick={() => maximizeWindow(id)} />
//               </div>
//             ) : (
//               <div className="window-header">
//                 <h3>{name}</h3>

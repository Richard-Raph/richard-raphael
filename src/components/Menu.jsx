...
// import { useState, useEffect } from 'react';
// import logo from '../assets/images/logo-fff.webp';
// import { TbWifi, TbWorldCancel, TbBluetooth, TbBluetoothOff, TbBattery, TbBatteryCharging2, TbBatteryEco, TbBatteryExclamation } from 'react-icons/tb';
...
//   if (charging) return TbBatteryCharging2;
//   if (level <= 0.1) return TbBatteryExclamation; // Critical level
//   if (level <= 0.2) return TbBatteryEco; // Low battery level
//   return TbBattery; // Normal
// };
...
//                 {/* Battery Icon */}
//                 {React.createElement(getBatteryIcon(battery.level, battery.charging), {
//                   size: 24,
...
//                     background: battery.level > 0.2 ? '#0f0' : '#f00',
